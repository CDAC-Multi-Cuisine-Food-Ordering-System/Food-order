...
import DeliveryRegister from "./UserComponent/DeliveryRegister.jsx"
...
import { darkTheme } from "./NavbarComponent/theme/DarkTheme";
  ...
  return (
    ...
    <div>
      ...
      <Routes>
        ...
        <Route path="/restaurant/delivery/register" element={<DeliveryRegister  />} />
